...
namespace LibraryAnimals
{
    ...
    public class ClovenHoofed : Animal
    {
        ...
        {
            return $"{Type}: Название - {Name} / Масса - {Weight} / Возраст - {Age} / Диаметр копыта - {HoofDiameter} / Длина тела - {BodyLength}";
        }
        ...
        public override bool IsContains(string searchText)
        {
            if (Name == searchText ||
                ...
                HoofDiameter.ToString() == searchText ||
                BodyLength.ToString() == searchText)
                return true;
            else
                return false;
        }
